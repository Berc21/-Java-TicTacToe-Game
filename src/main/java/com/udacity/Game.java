...
public class Game {
    ...
    public Boolean checkHorizontally(char ticked) {
        for (int row = 0; row < 3 ; row++) {
            if(grid[0][row] == ticked && grid[1][row] == ticked && grid[2][row] == ticked ) {
                return true;
            }
        }
        return false;
    ...
    public Boolean checkVertically(char ticked) {
        for (int row = 0; row < 3 ; row++) {
            if(grid[row][0] == ticked && grid[row][1] == ticked && grid[row][2] == ticked ) {
                return true;
            }
        }
        return false;
    ...
    public Boolean checkDiagonally(char ticked) {

        if( (grid[0][0] == ticked && grid[1][1] == ticked && grid[2][2] == ticked) ||
                grid[0][2] == ticked && grid[1][1] == ticked && grid[2][0] == ticked)
        {
                return true;
        }
        return false;
